...
input <- read_tsv("/home/nick/Downloads/Fusion_Prioritization/star-fusion.fusion_predictions.abridged.annotated.coding_effect.tsv")
geneList <- geneList <-read_tsv("/home/nick/Downloads/Fusion_Prioritization/data/processed/CancerGeneList.txt")
